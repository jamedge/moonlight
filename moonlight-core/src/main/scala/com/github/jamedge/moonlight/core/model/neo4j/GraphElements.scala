...
object GraphElements {
  ...
  sealed class Node(override val name: String) extends ElementClass(name, ElementType.Node)
  sealed class RelationshipRight(override val name: String) extends ElementClass(name, ElementType.RelationshipRight)

  object ElementClass {
    // Nodes
    case object Line extends Node("Line")
    case object IO extends Node("IO")
    case object Details extends Node("Details")
    case object Storage extends Node("Storage")
    case object Process extends Node("Process")
    case object ProcessingFramework extends Node("ProcessingFramework")
    case object ProcessingHistory extends Node("ProcessingHistory")
    case object Metric extends Node("Metric")
    case object MetricsFramework extends Node("MetricsFramework")
    case object Alert extends Node("Alert")
    case object AlertsFramework extends Node("AlertFramework")
    case object Code extends Node("Code")

    // Relationships
    case object HasDetails extends RelationshipRight("HAS_DETAILS")
    case object HasInput extends RelationshipRight("HAS_INPUT")
    case object HasOutput extends RelationshipRight("HAS_OUTPUT")
    case object HasStorage extends RelationshipRight("HAS_STORAGE")
    case object IsProcessedBy extends RelationshipRight("IS_PROCESSED_BY")
    case object HasProcessingFramework extends RelationshipRight("HAS_PROCESSING_FRAMEWORK")
    case object HasProcessingHistory extends RelationshipRight("HAS_PROCESSING_HISTORY")
    case object HasProcessingHistoryRecord extends RelationshipRight("HAS_PROCESSING_HISTORY_RECORD")
    case object HasMetrics extends RelationshipRight("HAS_METRIC")
    case object HasMetricsFramework extends RelationshipRight("HAS_METRICS_FRAMEWORK")
    case object HasAlert extends RelationshipRight("HAS_ALERT")
    case object HasAlertsFramework extends RelationshipRight("HAS_ALERTS_FRAMEWORK")
    case object HasCode extends RelationshipRight("HAS_CODE")
  }
}
